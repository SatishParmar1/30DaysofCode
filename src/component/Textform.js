...
=======
  <button className="btn btn-outline-success mr-3 my-3" id="2" onClick={handleupper}> Convert to Upper Case</button>
  <button className="btn btn-outline-success mx-5 my-3" id="3" onClick={handlelower} > Convert to lower case</button>
