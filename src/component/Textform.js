...
<div className="container " style={{color: props.mode==='dark' ? 'white' : 'black'}}> 
     ...
     <p className='d-flex justify-content-center border border-seconday rounded' id="privue" style={{backgroundColor:props.mode==='dark' ? 'gray' : 'rgb(245,245,245)', cursor: props.mode === 'dark' ? 'pointer' : 'text',color: props.mode==='dark' ? 'dark' : 'black' }}> {text.length>0?text:"Enter Somthing in Text area to Print"}</p>
     </div>
  </>
  )
}
